...
export interface EnvironmentConfig {
  ...
  //  Registro de Envíos Auth
  apiBaseUrlRegistroEnviosDev: string
  baseUrlRegistroEnviosDev: string
  authUsername: string
  authPassword: string
  authClientId: string
...
export const environment: EnvironmentConfig = {
  ...
  apiBaseUrlRegistroEnviosDev: process.env.API_BASE_URL_REGISTRO_ENVIO_DEV || '',
  baseUrlRegistroEnviosDev: process.env.BASE_URL_REGISTRO_ENVIO_DEV || '',
