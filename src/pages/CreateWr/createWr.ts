...
this.inputTracking = page.locator('#tracking')
this.consignee = page.locator('#searchConsignee')
this.listShipper = page.locator('#select2-shipper_id-container')
this.listCarrier = page.locator('#select2-carrier_id-container')
...
this.inputInvoice = page.locator('#invoice')
this.inputwrExterno = page.locator('#wr_externo')
this.inputinstrucciones = page.locator('#instructions')
this.inputNotaAdm = page.locator('#descripcion2')
this.inputNotaGen = page.locator('#descripcion1')
